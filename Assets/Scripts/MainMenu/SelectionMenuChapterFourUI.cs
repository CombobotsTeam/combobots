...
public class SelectionMenuChapterFourUI : MonoBehaviour
{
	...
	public void On_Lvl1()
	{
		...
		GUIAnimSystemFREE.Instance.EnableAllButtons(false);
		scenesInfos.currentScene = "Scene07";
	...
	public void On_Lvl6()
	{
		SoundManager.instance.Play("FurtherMenu3", false);
		GUIAnimSystemFREE.Instance.EnableAllButtons(false);
		scenesInfos.currentScene = "Scene08";
	...
	public void On_NextChapter()
	{
		SoundManager.instance.Play("FurtherMenu3", false);
		GUIAnimSystemFREE.Instance.EnableAllButtons(false);
		GUIAnimSystemFREE.Instance.LoadLevel("SelectionMenuChapterFour", 1.1f);
		gameObject.SendMessage("HideAllGUIs");
	}
	...
	private void check_save()
	{
		...
		nextChapter = GameObject.Find ("Chapter5");
